...
for archi in ['tied','untied','inertial-tied','inertial-untied']:
    algo = UTitanIvaG(name='UTitan'+'_'+archi,archi=archi,dimensions=(Ns[0],10000,Ks[0]),data_case=data_case,num_layers=500,tol=1e-3)
    algos.append(algo)

exp = ComparisonExperimentIvaG(name='Unrolling_comparison_small',dataparams_titles=[data_case],common_params=common_params,algos=algos,N_exp=10)
